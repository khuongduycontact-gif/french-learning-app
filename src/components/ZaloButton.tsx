...
// Icon đơn giản: nền tròn xanh Zalo, chữ "Zalo" trắng — không phụ thuộc file ảnh nào.
...
export default function ZaloButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-40 flex h-10 w-10 items-center justify-center rounded-full bg-[#0068FF] shadow-lg transition duration-200 hover:scale-105"
    >
