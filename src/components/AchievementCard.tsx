...
export default function AchievementCard({
  ...
  return (
    <>
      {/* Bọc ngoài (KHÔNG overflow-hidden) chỉ giữ shadow/rounded-2xl/hover -
          tách riêng khỏi khối overflow-hidden bên trong, đồng bộ cách làm với
          CourseCard/BookCard/BookSlider/TrustedWebsiteSlider để bóng đổ khi
          hover ôm đều quanh thẻ, không bị cắt/bó hẹp sát viền dưới. */}
      <div className="group/card rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-bordeaux/10">
